# -*- coding: utf-8 -*-
"""
Created on Wed Jul 21 15:17:52 2021
...
if __name__ == '__main__':
    ...
    # the planting date was moved ahead by 10 days
    aheadDay = 10
    start_date = ['2039','7','%d'%(15-aheadDay)]     
    ensemble_n = 30
    np.random.seed(0)
    outPath = 'OSSresult_1obs_phenoShift'#'OSSresult_1obs'
    saveResult = False
    forceOpenloop = False
    OSS_path='OSSE_truth'
    ...
    for case_n, state_case in enumerate(state_case_list):
        ...
        R = np.diag([0.03**2])  # measurement cov matrix
        P0 = np.diag([0.])
