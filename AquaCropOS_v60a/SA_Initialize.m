function [] = SA_Initialize(input,output,clock,para)
...
%% read parameters %%
[Soilprofile,Soil,CropMix,Crop,Irr,FieldMngtStruct,SoilHydro,IniWC] = SA_Parameters();
if ~isempty(para)
    [Soil,Crop,SoilHydro] = SA_Parameters_tune(Soil,Crop,CropMix,SoilHydro,para);
end
...
ParamStruct = SA_ComputeVariables(ParamStruct,WeatherStruct,...
