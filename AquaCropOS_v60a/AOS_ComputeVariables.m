...
if ParamStruct.Soil.CalcSHP == 0
    ...
    ParamStruct.Soil.Layer.Penetrability = Data{1,7}(:)';
...
elseif ParamStruct.Soil.CalcSHP == 1
    ...
    % Load data
    Data = textscan(fileID,'%f %f %f %f %f %f','headerlines',2);
    fclose(fileID);
    ...
    ParamStruct.Soil.Layer.Penetrability = Data{1,6}(:)';
    ParamStruct.Soil.Layer.DF = 1;
