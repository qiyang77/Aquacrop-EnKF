function [ParamStruct,CropChoices,FileLocation] = DA_ReadModelParameters(FileLocation, date_p, date_h)
...
for ii = 1:nCrops
    ...
    textscan(fileID,'%s %*s',1,'delimiter',':');      %  commented by Qi, revised to occupy position
    textscan(fileID,'%s %*s',1,'delimiter',':');
